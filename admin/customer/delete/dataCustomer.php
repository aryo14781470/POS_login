<?php
    ...
    function tambahCustomer(){
        ...
        if(!$result){ 
            ...
            $alert = $_SESSION['alert'] = warningAlert("Warning! ","Data Customer Gagal Disimpan. ($eror)");
			return $alert;
        } else {
			$data = [
				'status' => 'Succes! ',
				'message' => 'Data Customer '.$namaCustomer.' Berhasil Disimpan',
				'data' => $result
			];
            $_SESSION['alert'] = successAlert($data['status'],$data['message']);
