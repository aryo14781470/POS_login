        ...
        ?>
            <tr>
                ...
                <td class="text-center">
                    <img src="../admin/assets/img/desain/<?php
                        if(empty($row['gambar'])){ echo "noimage.jpg"; }
                        else { echo $row['gambar']; }?>" 
                        class="rounded float-start" weight="250px" height="200px">
                </td>
                <td class="text-center">
                    <button type="button" class="btn btn-link btn-md text-danger" data-bs-toggle="modal" data-bs-target="#deleteGambar_<?=$idGambar?>"><i class="fa fa-trash"></i></button>
