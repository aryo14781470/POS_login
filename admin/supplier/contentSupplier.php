                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-link btn-md text-warning" data-bs-toggle="modal" data-bs-target="#updateSupplier_<?=$idSupplier?>"><i class="fa-regular fa-pen-to-square"></i></button>
                                    <button type="button" class="btn btn-link btn-md text-danger" data-bs-toggle="modal" data-bs-target="#deleteSupplier_<?=$idSupplier?>"><i class="fa fa-trash"></i></button>
