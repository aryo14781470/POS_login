      ...
      <div class="modal-body">
        <form role="form" method="post" class="was-validated" enctype="multipart/form-data">
            <div class="input-group">
                ...
                <input type="text" name="idSupplier" class="form-control" placeholder="xxxxx" required>
            </div>
            <br>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="emailSupplier" class="form-control" placeholder="email supplier" required>
            </div>
            <br>
            <div class="input-group">
